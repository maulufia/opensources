    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/bbs/php_uploader/file_uploader_html5.php'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/bbs/photo_uploader/popup/file_uploader.php',	//샘플 URL입니다.
 	        sCallback : '/bbs/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
